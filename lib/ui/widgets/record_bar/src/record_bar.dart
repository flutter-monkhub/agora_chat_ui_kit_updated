      ...
      children: [
        ...
        Text(
          recordType == RecordBarRecordType.idle
              ? "Tap to record"  //ChatUIKitLocal.recordBarRecord.localString(context)
              : recordType == RecordBarRecordType.recording
                  ? "Recording..." //ChatUIKitLocal.recordBarRecording.localString(context)
                  : recordType == RecordBarRecordType.recorded
                      ? "Tap to play" //ChatUIKitLocal.recordBarPlay.localString(context)
                      : "Playing audio", //ChatUIKitLocal.recordBarPlaying.localString(context),
          textScaler: TextScaler.noScaling,
